...
return array(
    'ctrl' => array(
        ...
        'searchFields'             => 'client, owner_id, network_initial, library_identifier, admin_email, project, 
            ...
            submitter_ingest_notification_subject, submitter_ingest_notification_body, file_xpath, date_xpath, urn_xpath, state_xpath, type_xpath, type_xpath_input, namespaces',
